...
export default function App() {
  return (
    <div className="App">
      ...
      <div className="Third">
        <div>
          <h5>Q - How do I make a flight booking on DreamTrip?</h5>
          <p>
            A: You can book a flight on MakeMyTrip in five easy steps: Head over
            to the DreamTrip flight booking page, Enter your departure and
            ...
            can also use the DreamTrip app for your flight ticket booking.
            Download the DreamTrip app, Put in the details i.e. date of
        ...
        <div>
          <h5>Q - Can I avail domestic flight offers on DreamTrip?</h5>
          <p>
        ...
        <div>
          <h5>Q - How can I avail budget air tickets on DreamTrip?</h5>
          <p>
            A: It’s super-easy to avail budget airfare while booking your flight
            tickets on DreamTrip. Just select the ‘Price’ filter once the
        ...
        <div>
          ...
          <p>
            A: DreamTrip makes use of a world-class real-time reservation
